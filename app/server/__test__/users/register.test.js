...
describe("testing register", function () {
    ...
    test("register successfully", async() => {
        const account = {
            profile: {firstname: "Ken", lastname: "Apple"},
            username: "aaa", password: "aaaaaa", email: "aa@gmail.com", role: "student"};
    ...
    test("register without username", async() => {
        const account = {
            profile: {firstname: "Ken", lastname: "Apple"},
            password: "aaaaaa", email: "aa@gmail.com", role: "student"};
        const res = await request(app).post("/api/user/register").send(account);
    ...
    test("the username contains invalid symbols", async() => {
        const account = {
            profile: {firstname: "Ken", lastname: "Apple"},
            username: "!@#", password: "aaaaaa", email: "aa@gmail.com", role: "student"};
        const res = await request(app).post("/api/user/register").send(account);
        expect(res.statusCode).toBe(400);
        expect(res.text).toEqual("\"username\" with value \"!@#\" fails to match the required pattern: /\\w/");
    });
    test("the username is too short", async() => {
        const account = {
            profile: {firstname: "Ken", lastname: "Apple"},
            username: "aa", password: "aaaaaa", email: "aa@gmail.com", role: "student"};
        const res = await request(app).post("/api/user/register").send(account);
        expect(res.statusCode).toBe(400);
    ...
    test("the username is too long", async() => {
        const account = {
            profile: {firstname: "Ken", lastname: "Apple"},
            username: "aa".repeat(30), password: "aaaaaa", email: "aa@gmail.com", role: "student"};
        const res = await request(app).post("/api/user/register").send(account);
        expect(res.statusCode).toBe(400);
    ...
    test("register without password", async() => {
        const account = {
            profile: {firstname: "Ken", lastname: "Apple"},
            username: "aaa", email: "aa@gmail.com", role: "student"};
        const res = await request(app).post("/api/user/register").send(account);
        expect(res.statusCode).toBe(400);
    ...
    test("the password is too short", async() => {
        const account = {
            profile: {firstname: "Ken", lastname: "Apple"},
            username: "aaa", password: "aaa", email: "aa@gmail.com", role: "student"};
        const res = await request(app).post("/api/user/register").send(account);
        expect(res.statusCode).toBe(400);
    ...
    test("the password is too long", async() => {
        const account = {
            profile: {firstname: "Ken", lastname: "Apple"},
            username: "aaa", password: "aaaaaa".repeat(50), email: "aa@gmail.com", role: "student"};
        const res = await request(app).post("/api/user/register").send(account);
        expect(res.statusCode).toBe(400);
    ...
    test("register without email", async() => {
        const account = {
            profile: {firstname: "Ken", lastname: "Apple"},
            username: "aaa", password: "aaaaaa", role: "student"};
        const res = await request(app).post("/api/user/register").send(account);
        expect(res.statusCode).toBe(400);
    ...
    test("register with invalid email format", async() => {
        const account = {
            profile: {firstname: "Ken", lastname: "Apple"},
            username: "aaa", password: "aaaaaa", email: "gmail.com", role: "student"};
        const res = await request(app).post("/api/user/register").send(account);
        expect(res.statusCode).toBe(400);
    ...
    test("register without role", async() => {
        const account = {
            profile: {firstname: "Ken", lastname: "Apple"},
            username: "aaa", password: "aaaaaa", email: "aa@gmail.com"};
        const res = await request(app).post("/api/user/register").send(account);
        expect(res.statusCode).toBe(400);
    ...
    test("register with unexpected role", async() => {
        const account = {
            profile: {firstname: "Ken", lastname: "Apple"},
            username: "aaa", password: "aaaaaa", email: "aa@gmail.com", role: "engineer"};
        const res = await request(app).post("/api/user/register").send(account);
        expect(res.statusCode).toBe(400);

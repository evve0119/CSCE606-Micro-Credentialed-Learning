...
Given('I am at the add new course page',async function () {
    await this.driver.wait(until.elementLocated(By.xpath("//*[@id='addNewCourse']")), 10000);
...
When('I click on a course', async function () {
    await this.driver.wait(until.elementLocated(By.xpath("//a[@href='/instructor/courses/63656c1a51387dfd711dbcf1/edit']")), 10000);
...
When('I click on the update course button', async function () {
